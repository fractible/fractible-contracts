...
const sell_arg_to_mich = (s_asset_contract: att.Address, s_asset_token_id: att.Nat, s_sale_type: asset_type, s_sale_asset: att.Bytes, s_sale: sale): att.Micheline => {
    return att.pair_to_mich([
        s_asset_contract.to_mich(),
        s_asset_token_id.to_mich(),
        s_sale_type.to_mich(),
        s_sale_asset.to_mich(),
        s_sale.to_mich()
    ]);
}
...
export class Sales {
    ...
    async deploy(owner: att.Address, protocol_fee: att.Nat, transfer_manager: att.Address, sales_storage: att.Address, params: Partial<ex.Parameters>) {
    ...
    async sell(s_asset_contract: att.Address, s_asset_token_id: att.Nat, s_sale_type: asset_type, s_sale_asset: att.Bytes, s_sale: sale, params: Partial<ex.Parameters>): Promise<any> {
        if (this.address != undefined) {
    ...
    async get_sell_param(s_asset_contract: att.Address, s_asset_token_id: att.Nat, s_sale_type: asset_type, s_sale_asset: att.Bytes, s_sale: sale, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
