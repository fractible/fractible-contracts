...
const manage_transfers_arg_to_mich = (mt_bundle: Array<bundle_item>, mt_nft_origin: att.Address, mt_nft_destination: att.Address, mt_ft_amount: att.Nat, mt_ft_asset_type: asset_type, mt_ft_asset: att.Bytes, mt_ft_origin: att.Address, mt_ft_destination: att.Address, mt_custody: att.Address, mt_protocol_fees: att.Nat, mt_origin_fees: Array<part>, mt_payouts: Array<part>): att.Micheline => {
    return att.pair_to_mich([
...
export class Transfer_manager {
    ...
    async manage_transfers(mt_bundle: Array<bundle_item>, mt_nft_origin: att.Address, mt_nft_destination: att.Address, mt_ft_amount: att.Nat, mt_ft_asset_type: asset_type, mt_ft_asset: att.Bytes, mt_ft_origin: att.Address, mt_ft_destination: att.Address, mt_custody: att.Address, mt_protocol_fees: att.Nat, mt_origin_fees: Array<part>, mt_payouts: Array<part>, params: Partial<ex.Parameters>): Promise<any> {
        if (this.address != undefined) {
            return await ex.call(this.address, "manage_transfers", manage_transfers_arg_to_mich(mt_bundle, mt_nft_origin, mt_nft_destination, mt_ft_amount, mt_ft_asset_type, mt_ft_asset, mt_ft_origin, mt_ft_destination, mt_custody, mt_protocol_fees, mt_origin_fees, mt_payouts), params);
        }
        throw new Error("Contract not initialised");
    }
    ...
    async get_manage_transfers_param(mt_bundle: Array<bundle_item>, mt_nft_origin: att.Address, mt_nft_destination: att.Address, mt_ft_amount: att.Nat, mt_ft_asset_type: asset_type, mt_ft_asset: att.Bytes, mt_ft_origin: att.Address, mt_ft_destination: att.Address, mt_custody: att.Address, mt_protocol_fees: att.Nat, mt_origin_fees: Array<part>, mt_payouts: Array<part>, params: Partial<ex.Parameters>): Promise<att.CallParameter> {
        if (this.address != undefined) {
            return await ex.get_call_param(this.address, "manage_transfers", manage_transfers_arg_to_mich(mt_bundle, mt_nft_origin, mt_nft_destination, mt_ft_amount, mt_ft_asset_type, mt_ft_asset, mt_ft_origin, mt_ft_destination, mt_custody, mt_protocol_fees, mt_origin_fees, mt_payouts), params);
        }
        throw new Error("Contract not initialised");
    }
