...
const manage_transfers_arg_to_mich = (mt_bundle: Array<bundle_item>, mt_nft_origin: ex.Address, mt_nft_destination: ex.Address, mt_ft_amount: ex.Nat, mt_ft_asset_type: asset_type, mt_ft_asset: ex.Bytes, mt_ft_origin: ex.Address, mt_ft_destination: ex.Address, mt_custody: ex.Address, mt_protocol_fees: ex.Nat, mt_origin_fees: Array<part>, mt_payouts: Array<part>): ex.Micheline => {
    return ex.pair_to_mich([
...
export class Transfer_manager {
    ...
    async manage_transfers(mt_bundle: Array<bundle_item>, mt_nft_origin: ex.Address, mt_nft_destination: ex.Address, mt_ft_amount: ex.Nat, mt_ft_asset_type: asset_type, mt_ft_asset: ex.Bytes, mt_ft_origin: ex.Address, mt_ft_destination: ex.Address, mt_custody: ex.Address, mt_protocol_fees: ex.Nat, mt_origin_fees: Array<part>, mt_payouts: Array<part>, params: Partial<ex.Parameters>): Promise<any> {
        if (this.address != undefined) {
    ...
    async get_manage_transfers_param(mt_bundle: Array<bundle_item>, mt_nft_origin: ex.Address, mt_nft_destination: ex.Address, mt_ft_amount: ex.Nat, mt_ft_asset_type: asset_type, mt_ft_asset: ex.Bytes, mt_ft_origin: ex.Address, mt_ft_destination: ex.Address, mt_custody: ex.Address, mt_protocol_fees: ex.Nat, mt_origin_fees: Array<part>, mt_payouts: Array<part>, params: Partial<ex.Parameters>): Promise<ex.CallParameter> {
        if (this.address != undefined) {
